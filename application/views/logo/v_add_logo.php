<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-8 text-gray-800">
            ...
            <form id="form-tambah-logo" method="post" action="<?= site_url('logo/insert') ?>" enctype="multipart/form-data">
                <div class="row mb-3">
                    <label for="email" class="col-sm-2 col-form-label">Nama Gereja</label>
                    <div class="col-sm-10">
                        <input require type="text" class="form-control" name="nama_gereja">
                    </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="form-group row justify-content-end">
                    <div class="col-sm-10">
                        <button type="submit" class="btn" id="btn-save-logo" style="background-color: #2a5d68; color: #ededed;">Simpan</button>
...
<script>
    $(function() {
        $("#btn-save-logo").on("click", function() {
            let validate = $("#form-tambah-logo").valid()
            if (validate) {
                $("#form-tambah-logo").submit()
            }
        })
        $("#form-tambah-logo").validates({
            rules: {
                nama_gereja: {
                    digits: true
                },
