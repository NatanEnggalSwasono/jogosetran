        ...
        <div class="col-lg-8 text-gray-800">
            ...
            <form id="form-update-tentang" method="post" action="<?= site_url('tentang/update') ?>" enctype="multipart/form-data">
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input require type="text" class="form-control" value="<?= $tentang->nama_gereja ?>" name="nama_gereja">
                    </div>
                </div>
                <div class="row mb-3">
                    <label for="name" class="col-sm-2 col-form-label">Deskripsi Gereja</label>
                    <div class="col-sm-10">
                        <textarea require type="text" class="form-control" name="deskripsi_gereja" rows="7"><?= $tentang->deskripsi_gereja ?></textarea>
                    </div>
                </div>
                <div class="row mb-3">
                    <label for="name" class="col-sm-2 col-form-label">Visi</label>
                    <div class="col-sm-10">
                        <textarea require type="text" class="form-control" name="visi" rows="3"><?= $tentang->visi ?></textarea>
                    </div>
                </div>
                <div class="row mb-3">
                    <label for="name" class="col-sm-2 col-form-label">Misi</label>
                    <div class="col-sm-10">
                        <textarea require type="text" class="form-control" name="misi" rows="3"><?= $tentang->misi ?></textarea>
                    </div>
                </div>
