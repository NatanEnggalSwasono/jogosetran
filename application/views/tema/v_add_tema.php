<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-8 text-gray-800">
            ...
            <form id="form-tambah-tema" method="post" action="<?= site_url('tema/insert') ?>" enctype="multipart/form-data">
                <div class="row mb-3">
                    <label for="email" class="col-sm-2 col-form-label">Judul</label>
                    <div class="col-sm-10">
                        <input require type="text" class="form-control" name="judul">
                    </div>
                </div>
                <div class="row mb-3">
                    <label for="name" class="col-sm-2 col-form-label">Tema</label>
                    <div class="col-sm-10">
                        <textarea require type="text" class="form-control" name="tema" rows="3"></textarea>
                    </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="form-group row justify-content-end">
                    <div class="col-sm-10">
                        <button type="submit" class="btn" id="btn-save-tema" style="background-color: #2a5d68; color: #ededed;">Simpan</button>
                        <a href="<?= site_url('tema') ?>" class="btn btn-md" style="background-color: #2b58bf; color: #ededed;">
...
<script>
    $(function() {
        $("#btn-save-tema").on("click", function() {
            let validate = $("#form-tambah-tema").valid()
            if (validate) {
                $("#form-tambah-tema").submit()
            }
        })
        $("#form-tambah-tema").validates({
            rules: {
                tema: {
                    digits: true
                },
