        ...
        <div class="col-lg-8 text-gray-800">
            ...
            <form id="form-update-tema" method="post" action="<?= site_url('tema/update') ?>" enctype="multipart/form-data">
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input require type="text" class="form-control" value="<?= $tema->judul ?>" name="judul">
                    </div>
                </div>
                <div class="row mb-3">
                    <label for="name" class="col-sm-2 col-form-label">Tema</label>
                    <div class="col-sm-10">
                        <textarea require type="text" class="form-control" name="tema" rows="7"><?= $tema->tema ?></textarea>
                    </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="form-group row justify-content-end">
                    <div class="col-sm-10">
                        <button type="submit" class="btn" id="btn-update-tema" style="background-color: #2a5d68; color: #ededed;">Simpan</button>
...
<script>
    $(function() {
        $("#btn-update-tema").on("click", function() {
            let validate = $("#form-update-tema").valid()
            if (validate) {
                $("#form-update-tema").submit()
            }
        })
        $("#form-update-tema").validates({
            rules: {
                harga_barang: {
                    digits: true
                },
