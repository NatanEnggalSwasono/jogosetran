        ...
        <div class="col-lg-8 text-gray-800">
            ...
            <form id="form-update-pendeta" method="post" action="<?= site_url('pendeta/update') ?>" enctype="multipart/form-data">
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input require type="text" class="form-control" value="<?= $pendeta->nama_pendeta ?>" name="nama_pendeta">
                    </div>
                </div>
                <div class="row mb-3">
                    <label for="name" class="col-sm-2 col-form-label">Background Pendeta</label>
                    <div class="col-sm-10">
                        <textarea require type="text" class="form-control" name="background_pendeta" rows="7"><?= $pendeta->background_pendeta ?></textarea>
                    </div>
                </div>
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <div class="row">
                            <div class="col-sm-3">
                                <img src="<?= base_url('gambar/pendeta/') . $pendeta->foto_pendeta; ?>" class="img-thumbnail" width="150px;">
                            </div>
                            <div class="col-sm-9">
                ...
                <div class="form-group row justify-content-end">
                    <div class="col-sm-10">
                        <button type="submit" class="btn" id="btn-update-pendeta" style="background-color: #2a5d68; color: #ededed;">Simpan</button>
