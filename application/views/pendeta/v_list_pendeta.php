...
<body>
    <div class="container">
        ...
        <div class="container">
            <a href="<?= site_url('pendeta/tambah') ?>" class="btn btn-sm" style="background-color: #2a5d68; color:aliceblue;">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?= $p->background_pendeta ?></td>
                                <td><img src="<?= base_url("/gambar/pendeta/$p->foto_pendeta") ?>" width="100px"></td>
                                <td>
