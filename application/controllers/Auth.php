...
class Auth extends CI_Controller
{
    ...
    private function _sendEmail($token, $type)
    {
        $config = [
            ...
            'smtp_user ' => 'natanswasono@gmail.com',
            'smtp_pass' => 'n@t@n123!@#',
            'smtp_port' => 465,
            'mailtype' => 'html',
            'charset' => 'utf-8',
        ...
        $this->email->from('natanswasono@gmail.com', 'Natan Enggal Swasono');
    ...
    public function resetPassword()
    {
        ...
        if ($user) {
            ...
            $this->session->set_flashdata('message', '<div class="alert alert-danger" role="alert">Reset password failed, Wrong password!</div>');
            redirect('auth');
        }
    }
